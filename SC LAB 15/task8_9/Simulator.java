...
public class Simulator {
    ...
    /**
     * Simulate one step of the simulation using the Actor interface.
     * This method is now decoupled from the concrete Animal class.
     */
    public void simulateOneStep(List<? extends Actor> actors) {
        for (Actor a : actors) {
            a.grow();
        }
    }
